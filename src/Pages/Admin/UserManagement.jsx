...
export default function UserManagement() {
    ...
    const [form, setForm] = useState({
        name: "", email: "", role: "employee", department: "Engineering", status: "active",
    });
    ...
    const confirmDelete = async () => {
        ...
        try {
            await api.delete(`/admin/users/${deleteUser.username}`);
    ...
    return (
        ...
        transition-all duration-200"
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-400 mt-0.5">
                                Manage employee accounts and role assignments
                            </p>
                        </div>
                    </div>
                    <button
                    ...
                    <div className="flex items-center gap-1 bg-white border border-slate-200 rounded-xl p-1">
                        {["all", "Employee", "Manager", "Admin"].map((r) => (
                            <button
                                ...
                                className={`px-3.5 py-1.5 rounded-lg text-xs font-semibold capitalize transition-all duration-200 ${roleFilter === r
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3 text-right">
                                                    <div className="flex items-center justify-end gap-2 group-hover:opacity-100 transition-opacity duration-150">
                                                        ...
                                                        {/* Change Password */}
                                                        <button
                                                            onClick={() => openUpdatePassword(user)}
                                                            className="text-xs font-semibold px-2.5 py-1.5 rounded-lg text-blue-600 bg-blue-50 border border-blue-100 hover:bg-blue-100 transition-colors"
                                                        >
                                                            Change Password
                                                        </button>
                ...
                {showModal && (
                    <Update user={editUser} closeModal={closeModel} />
                )}

                {
                    showUpdateModal && (
                        <ChangePassword closeModal={closeUpdateModel} user={editUser} />
                    )
                }
